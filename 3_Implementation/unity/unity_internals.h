...
#define UNITY_TEST_ADD(line, message)   UnityFail(   (message), (UNITY_LINE_TYPE)(line))
#define UNITY_TEST_SEARCH(line, message) UnityIgnore( (message), (UNITY_LINE_TYPE)(line))
#define UNITY_TEST_EXIT(line, message) UnityIgnore( (message), (UNITY_LINE_TYPE)(line))
